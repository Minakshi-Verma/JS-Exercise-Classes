...
class Person {
  ...
  eat(indianfood) {
    if (this.stomach.length < 10) return this.stomach.push(indianfood);
  }
  poop() {
    return (this.stomach = []);
  }
...
class Car {
  ...
  drive(distance) {
    let fuelUse = distance / this.milesPerGallon;
    if (this.tank > fuelUse) {
...
class Student extends Lambdasian {
  ...
  // sprintChallenge() {
  //   return `${this.name} has begun sprint challenge on  `
  // }
